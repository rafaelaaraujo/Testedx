...
public class ShoppingCartItemBinding extends android.databinding.ViewDataBinding  {
    ...
    private br.com.testedx.shoppingCart.model.Order mOrder;
    // values
    // listeners
    ...
    public ShoppingCartItemBinding(android.databinding.DataBindingComponent bindingComponent, View root) {
        ...
        this.txtIngredients = (android.widget.TextView) bindings[6];
        this.txtIngredients.setTag(null);
        this.txtPriceDiscounts = (android.widget.TextView) bindings[8];
        this.txtPriceDiscounts.setTag(null);
        this.txtSubtotal = (android.widget.TextView) bindings[7];
        this.txtSubtotal.setTag(null);
        this.txtTittle = (android.widget.TextView) bindings[5];
    ...
    public boolean setVariable(int variableId, Object variable) {
        switch(variableId) {
            case BR.s :
                ...
                return true;
            case BR.order :
                setOrder((br.com.testedx.shoppingCart.model.Order) variable);
                return true;
        }
        return false;
    }
    ...
    public void setOrder(br.com.testedx.shoppingCart.model.Order Order) {
        this.mOrder = Order;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    public br.com.testedx.shoppingCart.model.Order getOrder() {
        return mOrder;
    }
    ...
    protected void executeBindings() {
        ...
        java.lang.String stringUtilGetDateFormatedOrderGetDate = null;
        java.lang.String sGetName = null;
        long orderGetDate = 0L;
        ...
        br.com.testedx.shoppingCart.model.Order order = mOrder;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
                ...
                if (order != null) {
                    // read order.getDate()
                    orderGetDate = order.getDate();
                }


                // read StringUtil.getDateFormated(order.getDate())
                stringUtilGetDateFormatedOrderGetDate = br.com.testedx.util.StringUtil.getDateFormated(orderGetDate);
        }
        // batch finished
        if ((dirtyFlags & 0x6L) != 0) {
            // api target 1

            android.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView4, stringUtilGetDateFormatedOrderGetDate);
        }
        if ((dirtyFlags & 0x5L) != 0) {
            // api target 1
    ...
    /* flag mapping
        ...
        flag 4 (0x5L): s == null ? View.VISIBLE : View.GONE
        flag 5 (0x6L): s.getPromotionEnum() == PromotionEnum.NONE ? View.GONE : View.VISIBLE
        flag 6 (0x7L): s.getPromotionEnum() == PromotionEnum.NONE ? View.GONE : View.VISIBLE
        flag 7 (0x8L): s == null ? View.INVISIBLE : View.VISIBLE
        flag 8 (0x9L): s == null ? View.INVISIBLE : View.VISIBLE
    flag mapping end*/
    //end
}